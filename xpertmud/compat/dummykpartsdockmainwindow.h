...
class DLL_IMP_EXP_QEXTMDICLASS DockMainWindow : public KDockMainWindow
{
   Q_OBJECT
public:
   DockMainWindow( QWidget* parentWidget = 0L, const QString name = QString(), Qt::WindowFlags flags = Qt::Window, QList<Qt::WidgetAttribute> a = QList<Qt::WidgetAttribute>()) : KDockMainWindow( parentWidget, name, flags, a) {};
   ~DockMainWindow() {};
};
